...
void EmptyLinkFunctionForGeneratedCodeSammysGreatAdventureCharacter() {}
// Cross Module References
	SAMMYSGREATADVENTURE_API UClass* Z_Construct_UClass_ASammysGreatAdventureCharacter_NoRegister();
	SAMMYSGREATADVENTURE_API UClass* Z_Construct_UClass_ASammysGreatAdventureCharacter();
	ENGINE_API UClass* Z_Construct_UClass_ACharacter();
	UPackage* Z_Construct_UPackage__Script_SammysGreatAdventure();
	ENGINE_API UClass* Z_Construct_UClass_UCameraComponent_NoRegister();
	ENGINE_API UClass* Z_Construct_UClass_USpringArmComponent_NoRegister();
// End Cross Module References
	void ASammysGreatAdventureCharacter::StaticRegisterNativesASammysGreatAdventureCharacter()
	{
	}
	UClass* Z_Construct_UClass_ASammysGreatAdventureCharacter_NoRegister()
	{
		return ASammysGreatAdventureCharacter::StaticClass();
	}
	UClass* Z_Construct_UClass_ASammysGreatAdventureCharacter()
	{
		...
		if (!OuterClass)
		{
			...
			OuterClass = ASammysGreatAdventureCharacter::StaticClass();
			if (!(OuterClass->ClassFlags & CLASS_Constructed))
			{
				...
				UProperty* NewProp_CameraBoom = new(EC_InternalUseOnlyConstructor, OuterClass, TEXT("CameraBoom"), RF_Public|RF_Transient|RF_MarkAsNative) UObjectProperty(CPP_PROPERTY_BASE(CameraBoom, ASammysGreatAdventureCharacter), 0x00400000000a001d, Z_Construct_UClass_USpringArmComponent_NoRegister());
				OuterClass->ClassConfigName = FName(TEXT("Game"));
				static TCppClassTypeInfo<TCppClassTypeTraits<ASammysGreatAdventureCharacter> > StaticCppClassTypeInfo;
				...
				MetaData->SetValue(NewProp_BaseTurnRate, TEXT("ModuleRelativePath"), TEXT("SammysGreatAdventureCharacter.h"));
				MetaData->SetValue(NewProp_BaseTurnRate, TEXT("ToolTip"), TEXT("Base turn rate, in deg/sec. Other scaling may affect final turn rate."));
				MetaData->SetValue(NewProp_FollowCamera, TEXT("AllowPrivateAccess"), TEXT("true"));
				MetaData->SetValue(NewProp_FollowCamera, TEXT("Category"), TEXT("Camera"));
				MetaData->SetValue(NewProp_FollowCamera, TEXT("EditInline"), TEXT("true"));
				MetaData->SetValue(NewProp_FollowCamera, TEXT("ModuleRelativePath"), TEXT("SammysGreatAdventureCharacter.h"));
				MetaData->SetValue(NewProp_FollowCamera, TEXT("ToolTip"), TEXT("Follow camera"));
				MetaData->SetValue(NewProp_CameraBoom, TEXT("AllowPrivateAccess"), TEXT("true"));
				MetaData->SetValue(NewProp_CameraBoom, TEXT("Category"), TEXT("Camera"));
				MetaData->SetValue(NewProp_CameraBoom, TEXT("EditInline"), TEXT("true"));
				MetaData->SetValue(NewProp_CameraBoom, TEXT("ModuleRelativePath"), TEXT("SammysGreatAdventureCharacter.h"));
